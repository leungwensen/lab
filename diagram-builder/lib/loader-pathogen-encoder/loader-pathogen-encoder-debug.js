...
}, 'patched-v3.18.0', {"requires": ["get", "features"]});
...
}, 'patched-v3.18.0', {"requires": ["loader-base"]});
...
YUI.add('loader-pathogen-encoder', function (Y, NAME) {}, 'patched-v3.18.0', {"use": ["loader-base", "loader-rollup", "loader-yui3", "loader-pathogen-combohandler"]});
